<template>
  <div class="p-1">
    <div v-if="loading" class="d-flex justify-content-center p-3">
      <svg class="w-8 h-8 text-gray-800 animate-spin" xmlns="http://www.w3.org/2000/svg"
        ...
        <div
          ...
          <div class="flex-grow-1">
            <h4 class="font-weight-bold text-xl text-danger mb-3">
              {{
                (Object(prices).message) ? Object(prices).message : 'متاسفانه کاربر با این شناسه پیدا نشده است'
              }}

            </h4>
            <p class="font-weight-medium text-sm  text-dark mb-3">
              <br>لطفاً دوباره چند دقیقه دیگه امتحان کنید یا با پشتیبانی به شماره مشتری گرامی،
              در صورت عدم فعال سازی تمدید پشتیبانی محصولاتتان به دلایل سیستمی و مشکلات بانکی ( تراکنش
              ناموفق و …) با شماره‌ی 09045294338 از طریق تلگرام در ارتباط باشید.
            </p>
          </div>
        </div>
      </div>
